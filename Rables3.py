...
def menu():
    ...
    print 'AUTHOR   : Rebooting Rables TM'

    print 'FACEBOOK : https://www.facebook.com/RebootingRebels.Official'

    print 'GITHUB     : github.com/imran007it'
